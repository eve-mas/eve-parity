#!/bin/bash 
>cav_tcgen/detailed_exetime_gifford.txt
>cav_tcgen/overview_exetime_gifford.txt
...
do
	...
	echo "$i;$Ptime;$Cstr;$PGstr;$EmC;$ToT;$GLTLS;$GLTLE;$GParS;$GParE;$TTPGS;$TTPGE " | tee -a cav_tcgen/detailed_exetime_gifford.txt
	echo "$i;$GLTLS;$GLTLE;$GParS;$GParE;$ToT" | tee -a cav_tcgen/overview_exetime_gifford.txt
done
